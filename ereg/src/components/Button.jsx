...
const buttonClasses={
    ...
    disabledTiny:" opacity-50 hover:bg-gray-800 text-xs md:text-base bg-white text-gray-800 hover:text-white font-bold px-4 py-2   border-gray-800 border rounded cursor-not-allowed",
    ...
    standardTiny:"px-4 py-2 bg-white text-blue-500  hover:text-white rounded border border-blue-500 hover:bg-green-600 transition",
