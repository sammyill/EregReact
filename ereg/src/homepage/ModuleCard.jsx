...
import InputField from "./InputField"; // da togliere e spostare la logica su modulesforms
import TextArea from "./textArea"; // da togliere e spostare la logica su modulesforms
import InputSelect from "./InputSelect"; // da togliere e spostare la logica su modulesforms
import { fullName } from "../utilities";
import { fetchHelper } from "../utilities";//da rimuovere 
import { EregContext } from "../contexts/EregContext";
import { moduleDescription,moduleName,moduleLenght} from "./formsdasates"; //da togliere e spostare su module forms
...
export default function ModuleCard({title,modulePFN="sconosciuto",
  ...
  const [perationError,setOperationError]=useState(false)
